...
class ShortLinks {
    ...
    static render(obj){
        const content = `
            <ul class="shorten__genarate">
                <li class="shorten__long-link">${obj.url}</li>
                <li class="shorten__short-link"><a href="${obj.shortUrl}" target="_blank">${obj.shortUrl}</a></li>
                <li class="shorten__copy btn--blue"><button>Copy</button></li>
